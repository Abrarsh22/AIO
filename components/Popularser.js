...
borderBottomRightRadius:18}}>
    <Text style={{textAlign:'center',fontSize:13,letterSpacing:1.5,fontWeight:'bold',color:'#FFF'}}>{item.name}</Text>
    </View>
    </View>
    </View>
              </TouchableOpacity>
  ...
  componentDidMount() {
    const display="http://10.0.2.2:80/api/popularprod.php";
  ...
  textAlign:'center',color:'#000'}}>Popular Services</Text>
</View>
      <View
